...
(function () {
  // --- CONFIG ---
  const qrImgUrl = 'https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://khatti-cafe.vercel.app/menu';
  const menuLink = 'https://khatti-cafe.vercel.app/menu';
  ...
  popup.innerHTML = `
    <div class="popup-content">
      <span class="popup-title">Scan to Get Menu</span>
